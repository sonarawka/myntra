...
const Footer = () => {
    return (
        <div className={classes.footerMain}>
            <div className={classes.footerSubmain}>
                <div className='row'>
                    <div className='col-md-4 col-sm-6'>
                        <div className='row'>
                            <div className='col-md-6'>
                                <a className={`${classes.footerSubTitle} d-block my-4`} href='/'>ONLINE SHOPPING</a>
                                <a className='d-block text-decoration-none text-secondary' href="/">Men</a>
                                <a className='d-block text-decoration-none text-secondary' href="/">Women</a>
                                <a className='d-block text-decoration-none text-secondary' href="/">Kids</a>
                                <a className='d-block text-decoration-none text-secondary' href="/">Home & Living</a>
                                <a className='d-block text-decoration-none text-secondary' href="/">Beauty</a>
                                <a className='d-block text-decoration-none text-secondary' href="/">Gift Cards</a>
                                <a className='d-block text-decoration-none text-secondary' href="/">Myntra Insider</a>

                                <a className={`${classes.footerSubTitle} d-block my-4`} href='/'>USEFUL LINKS</a>
                                <a className='d-block text-decoration-none text-secondary' href="/">Blog</a>
                                <a className='d-block text-decoration-none text-secondary' href="/">Careers</a>
                                <a className='d-block text-decoration-none text-secondary' href="/">Site Map</a>
                                <a className='d-block text-decoration-none text-secondary' href="/">Corporate Information</a>
                                <a className='d-block text-decoration-none text-secondary' href="/">Whitehat</a>
                            </div>
                            <div className='col-md-6'>
                                <a className={`${classes.footerSubTitle} d-block my-4`} href='/'>CUSTOMER POLICIES</a>
                                <a className='d-block text-decoration-none text-secondary' href='/'>Contact Us</a>
                                <a className='d-block text-decoration-none text-secondary' href='/'>FAQ</a>
                                <a className='d-block text-decoration-none text-secondary' href='/'>T&C</a>
                                <a className='d-block text-decoration-none text-secondary' href='/'>Terms Of Use</a>
                                <a className='d-block text-decoration-none text-secondary' href='/'>Track Orders</a>
                                <a className='d-block text-decoration-none text-secondary' href='/'>Shipping</a>
                                <a className='d-block text-decoration-none text-secondary' href='/'>Cancellation</a>
                                <a className='d-block text-decoration-none text-secondary' href='/'>Returns</a>
                                <a className='d-block text-decoration-none text-secondary' href='/'>Privacy policy</a>
                                <a className='d-block text-decoration-none text-secondary' href='/'>Grievance Officer</a>
                            </div>
                        </div>
                    </div>
                    <div className='col-md-4 col-sm-6'>
                        <a className={`${classes.footerSubTitle} d-block my-4`} href='/'>EXPERIENCE MYNTRA APP ON MOBILE</a>
                        <div>
                            <img width="140px" src='https://constant.myntassets.com/web/assets/img/80cc455a-92d2-4b5c-a038-7da0d92af33f1539674178924-google_play.png' className='me-2' alt='' />
                            <img width="140px" src='https://constant.myntassets.com/web/assets/img/bc5e11ad-0250-420a-ac71-115a57ca35d51539674178941-apple_store.png' alt='' />
                        </div>
                        <a className={`${classes.footerSubTitle} d-block my-2`} href='/'>KEEP IN TOUCH</a>
                        <a className='text-decoration-none text-secondary' href='/'><FacebookIcon sx={{ fontSize: "30px" }} /></a>
                        <a className='text-decoration-none text-secondary mx-2' href='/'><TwitterIcon sx={{ fontSize: "30px" }} /></a>
                        <a className='text-decoration-none text-secondary' href='/'><YouTubeIcon sx={{ fontSize: "30px" }} /></a>
                        <a className='text-decoration-none text-secondary mx-2' href='/'><InstagramIcon sx={{ fontSize: "30px" }} /></a>

                    </div>
                    <div className='col-md-4 my-4 col-sm-6'>
                        <div className={classes.footerTopics}>
                            <img style={{ width: "48px", height: "40px" }} src='https://constant.myntassets.com/web/assets/img/6c3306ca-1efa-4a27-8769-3b69d16948741574602902452-original.png' alt='' />
                        ...
                        <div className={classes.footerTopics}>
                            <img style={{ width: "48px", height: "49px" }} src='https://constant.myntassets.com/web/assets/img/ef05d6ec-950a-4d01-bbfa-e8e5af80ffe31574602902427-30days.png' alt='' />
                ...
                <div>
                    <p className={`${classes.footerSubTitle} d-block my-4`}>POPULAR SEARCHES</p>
                    <a className='text-decoration-none text-secondary' style={{ fontSize: "15px" }} href='/'>Makeup | Dresses For Girls | T-Shirts | Sandals | Headphones | Babydolls | Blazers For Men | Handbags | Ladies Watches | Bags | Sport Shoes | Reebok Shoes | Puma Shoes | Boxers | Wallets | Tops| Earrings | Fastrack Watches | Kurtis | Nike | Smart Watches | Titan Watches | Designer Blouse | Gowns | Rings | Cricket Shoes | Forever 21 | Eye Makeup | Photo Frames | Punjabi Suits | Bikini | Myntra Fashion Show | Lipstick | Saree | Watches | Dresses | Lehenga | Nike Shoes | Goggles | Bras | Suit | Chinos | Shoes | Adidas Shoes | Woodland Shoes | Jewellery | Designers Sarees</a>
                </div>

                <div className='d-flex justify-content-between my-4'>
                    <div style={{ fontWeight: "100" }}>
                        In case of any concern, <a href='https://www.myntra.com/contactus' target="_blank" rel='noopener noreferrer' className={classes.footerLink}>Contact Us</a>
                    </div>
                    <div className={classes.fw100}>
                ...
                <div className='d-flex justify-content-between my-4'>
                    <div>
                        <p className={`${classes.footerSubTitle} d-block my-4`}>Registered Office Address</p>
                        <p className={classes.fw100}>Buildings Alyssa,<br />
                    ...
                    <div>
                        <p className={classes.fw100}>CIN: U72300KA2007PTC041799 <br /> Telephone: <a href='tel:+918061561999' className={classes.footerLink}>+91-80-61561999</a></p>
                    </div>
                </div>

                <hr />
                <div className="desktop-gyanContainer" data-reactid="348">
                    <h1><strong>ONLINE SHOPPING MADE EASY AT MYNTRA</strong></h1>
                    <p>If you would like to experience the best of online shopping for men, women and kids in India, you are at the right place. Myntra is the ultimate destination for fashion and lifestyle, being host to a wide array of merchandise including <a className="seolink" href="/clothing">clothing</a>, footwear, accessories, jewellery, personal care products and more. It is time to redefine your style statement with our treasure-trove of trendy items. Our online store brings you the latest in designer products straight out of fashion houses. You can shop online at Myntra from the comfort of your home and get your favourites delivered right to your doorstep.</p>
                    ...
                    <ul>
                        <li style={{ listStyleType: "disc" }}>Opportunity to master any domain in fashion with tips from celebrity stylists at Myntra Masterclass sessions.</li>
                        <li style={{ listStyleType: "disc" }}>Curated collections from celeb stylists.</li>
                    </ul>
                    <p><strong>Elite</strong></p>
                    <ul>
                        <li style={{ listStyleType: "disc" }}>VIP access to special sale events such as the End of Reason Sale (EORS) and product launches.</li>
                        <li style={{ listStyleType: "disc" }}>Exclusive early access to Limited Edition products</li>
                    </ul>
                    <p><strong>Icon</strong></p>
                    <ul>
                        <li style={{ listStyleType: "disc" }}>Chance to get on guest lists for special events.</li>
                    </ul>
                    ...
                    <p>Myntra is one such online shopping website that joins the list of platforms that help curate a personalised fashion feed. Named the<a className="seolink" href="/studio/home">Myntra Studio</a>, this personalised search feed brings you the latest men and women’s fashion trends, celebrity styles, branded content and daily updates from your favourite fashion labels.</p>
